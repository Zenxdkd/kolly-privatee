getgenv().afgas = {
    Main = {
        Enabled = true,
        Intro = false,
        PredictionType = "afgas", --// "Roblox" or "afgas"
        TargetMode = "FOV", --// "FOV" or "Target"
        UnlockOnKnock = true,
        HitParts = {"Head", "HumanoidRootPart"},
        ClosestToCursorHitpart = true,
    },
    SilentAim = {
        Enabled = true,
        TargetDot = false,
    ...
    AimAssist = {
        ...
        Smoothing = {
            ...
            StyleMethod = Enum.EasingStyle.Circular,
            StyleMethod2 = Enum.EasingDirection.InOut,
        }
    },
    FovSettings = {
        Visible = true,
